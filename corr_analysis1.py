...
class CorrelationAnalysis:
    def __init__(self, source, df, file_name,  problem_type, type_column, dependent_var, corr_thres):
        self.source = source
        self.data = df
...
#         self.scaler = MinMaxScaler()
    ...
    def random_forest_selection_numerical(self):
        try:
            ...
            # Save to CSV
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/most_correlated_features_with_{self.dependent_var}.csv'
    ...
    def pairplot(self):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/pairplot.png'
    ...
    def count_plot(self, dependent_var):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/count_plot.png'
    ...
    def corr_heatmap(self, df, dependent_var):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/heatmap.png'
    ...
    def my_corr_feature_selector(self, df, dependent_var, problem_type, corr_thres):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/all_correlated_features_with_{self.dependent_var}.csv'
            ...
            plt.tight_layout()
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/most_correlated_features_with_{self.dependent_var}.png'
    ...
    def Kruskal_Wallis_test(self, df):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/Kruskal-Wallis_result.csv'
