...
class MultiLinearRegression:
    def __init__(self, source, X, y, target_variable, scaler, scaler_y, label_encoder, file_name, problem_type):
        self.source = source
    ...
    def evaluate(self):
        ...
        # Saving the plot
        path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/true_values_vs_predicted_values_{self.target_variable}.png'
