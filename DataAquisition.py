...
class DataAquisition:
    ...
    def __init__(self, source, folder_path, file_name,):
...
#                 return 'unknown', None, list(data.columns), None
    ...
    def make_directories(self, problem_type, file_name):
        ...
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}") else None
        
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/graphs") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/graphs") else None
        
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/csv") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/csv") else None
        
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/models") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/models") else None
        
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/json") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/json") else None
        
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/report") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/report") else None
        
        os.makedirs(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/dataset") if not os.path.exists(f"Knowledge/{problem_type}/{self.source}/{self.file_name}/dataset") else None
        
    def move_dataset_to_knowledge(self, df):
        df.to_csv(f"Knowledge/{self.problem_type}/{self.source}/{self.file_name}/dataset/{self.file_name}")
