...
class CodeGeneration:
    ...
    def load_model(self):
        ...
        self.model = AutoModelForCausalLM.from_pretrained("deepseek-ai/deepseek-coder-1.3b-instruct", trust_remote_code=True).to(gpu_device)
    ...
    def code_inference(self):
        ...
        Given the '{self.question}' and '{self.data[6:10]}'. Define the following to answer this question.
        def analysis(data)
