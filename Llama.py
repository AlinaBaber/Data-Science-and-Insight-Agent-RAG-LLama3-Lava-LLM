...
#     def corrmat_explain(self,corrmat):
...
#         You also give short explanations or justifications only where required.
#         If you don't know the answer to a question, please don't share false information."""

#         SYSTEM_PROMPT = B_SYS + DEFAULT_SYSTEM_PROMPT + E_SYS


#         prompt = f"""Given the correlation matrix below :  [{corrmat}]. provide ture insights of the the dataset. """

#         generated_text = self.generate(prompt,SYSTEM_PROMPT,2000)
#         response = self.parse_text(generated_text)
