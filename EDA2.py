...
class EDA:
    def __init__(self, source, df, file_name, problem_type, type_column, dependent_var,date_index):
...
#     self.data = data
    ...
    #         self.data.describe().to_csv(f'LSTM_result_csv/data_description.csv')
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/summary_statistics.csv'
    ...
    def plot_bar_chart(self):
        try:
            path_for_json = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/bar_chart'
            ...
            for column in self.data.select_dtypes(include='object'):
                ...
                path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/bar_chart_{column}.png'
                plt.tight_layout()
                plt.savefig(path)
                plt.show()
        except Exception as e:
    ...
    def plot_stacked_bar_chart(self):
        try:
            path_for_json = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/stacked_column_chart'
            ...
            for x_column in self.data.select_dtypes(include='object'):
                for hue_column in self.data.select_dtypes(include='object'):
                    if x_column != hue_column:
                        ...
                        path = f'Knowledge/{problem_type}/{self.file_name}/graphs/stacked_column_chart_{x_column}_vs_{hue_column}.png'
    ...
    def create_cross_tab(self):
        try:
            path_for_json = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/Crosstab'
            self.dict_manager.update_value(f'Crosstabs of two columns ', path_for_json)
            path_for_json = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/Cross_tabulation'
            ...
            for column1 in self.data.select_dtypes(include='object'):
                for column2 in self.data.select_dtypes(include='object'):
                    if column1 != column2:
                        ...
                        path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/Crosstab_{column1}_vs_{column2}.csv'
    ...
    def perform_chi_square_test(self):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/csv/chi_square_statistics.csv'
    ...
    def plot_histogram_within_categories(self):
        try:
            path_for_json = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/histogram'
            ...
            for x_column in self.data.select_dtypes(include='number'):
                for hue_column in self.data.select_dtypes(include='object'):
                    ...
                    path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/histogram_{x_column}_vs_{hue_column}.png'
...
#             return False
    ...
    def msno_plot(self):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/mising_number_plot.png'
        ...
        try:
            ...
            for variable_name in df[numerical_columns].columns:
                ...
                if dependent_var is not None:
                    ...
                    path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/{variable_name}_with_{dependent_var}_trend_graph.png'
                    ...
                    path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/{variable_name}_trend_graph.png'
...
#         plt.show()
    ...
    def visualize_distribution(self, num_cols=3):
        ...
        #                 fig.delaxes(axes.flatten()[idx])
            ...
            plt.tight_layout()
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/probability_distributions.png'
...
#         plt.show()
    ...
    def pairwise_plots(self):
        try:
            sns.pairplot(self.data)
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/pairwise_plots.png'
...
#         plt.show()
    ...
    def correlation_analysis(self):
        try:
            ...
            path = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/graphs/correlation_heatmaps.png'
    ...
    def most_correlated_features(self, correlation_matrix, threshold=0.4):
        try:
            ...
            if not isinstance(correlation_matrix, pd.DataFrame):
                ...
                json_filename = f'Knowledge/{self.problem_type}/{self.source}/{self.file_name}/json/correlated_features.json'
